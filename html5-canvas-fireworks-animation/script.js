...
window.onmessage = function (e) {
	...
	console.log(imgList[randomNumber], 77777)
	console.log(appNodes.canvasContainer, 232)
	appNodes.canvasContainer.style.backgroundImage = `url(${imgList[randomNumber]} !important)`
	console.log(appNodes.canvasContainer.style.backgroundImage, 2222)
...
function configDidUpdate () {
	...
	Spark.drawWidth = quality === QUALITY_HIGH ? 0.85 : 1
}
...
function colorSky (speed, url) {
	...
	// appNodes.canvasContainer.style.backgroundImage = `url(../h5/img/bg-4.webp)`
	const img = url || '../img/bg-mb-3.jpg'
	appNodes.canvasContainer.style.backgroundImage = `url(${img})`
	appNodes.canvasContainer.style.backgroundRepeat = `no-repeat`
	appNodes.canvasContainer.style.backgroundSize = `100% 100%`
